...
var _user$project$Data$dataTriple = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
...
var _user$project$Data$dataDouble = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '«', _1: '»'},
		_1: {
...
var _user$project$Main$instructionView = function (instruction) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('en'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(instruction.label),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
							...
							return A2(
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(_elm_lang$core$Basics_ops['++'], '- ', example.word)),
									_1: {
										ctor: '::',
										_0: A2(
											...
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													A2(_elm_lang$core$Basics_ops['++'], '= ', example.desc)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Main$tutorialView = function (status) {
	var instructionList = {
		ctor: '::',
		_0: {
			...
			exampleList: {
				ctor: '::',
				_0: {word: 'គេ', desc: 'k + k + e'},
				_1: {
					ctor: '::',
					_0: {word: 'ល្បែង', desc: 'l + j + b + [e + e] + g'},
					_1: {ctor: '[]'}
				}
			}
		},
		_1: {
			...
			_1: {
				...
				_0: {
					...
					exampleList: {
						ctor: '::',
						_0: {word: 'ក ក', desc: 'k + [space + space] + k'},
						_1: {ctor: '[]'}
					}
				},
				_1: {
					...
					_0: {
						...
						exampleList: {
							ctor: '::',
							_0: {word: 'ខ្ញុំ', desc: 'x + j + space + [j + j] + u + [m + m]'},
							_1: {ctor: '[]'}
						}
					},
					_1: {ctor: '[]'}
						...
						_0: A2(
							...
							A2(
								...
								function (instruction) {
									return _user$project$Main$instructionView(instruction);
								},
								instructionList)),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var akharakroms = _elm_lang$core$Dict$fromList(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'Tom', _1: 'Cat'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Jerry', _1: 'Mouse'},
					_1: {ctor: '[]'}
				}
			});
		var _p0 = msg;
		if (_p0.ctor === 'ToggleTutorial') {
			return model.tutorialStatus ? {
				ctor: '_Tuple2',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Khmer Unicode Enhance'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$tutorialView(model.tutorialStatus),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('btn btn-primary my-btn copy-button en'),
									_1: {
										ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('មានយោបល់អ្វីអាចទំនាក់ទំនងបានតាម '),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$a,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$href('https://www.facebook.com/pg/Elm-Cambodia-1192992554180521/'),
																_1: {ctor: '[]'}
															}
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Elm Cambodia'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('បង្កើតឡើងដោយ '),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$a,
